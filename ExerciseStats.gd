...
export(String, "Calisthenic", "Weighted") var exercise_type
export var rep_time : float
export var money_earned : float
export(String, "Chest", "Shoulders", "Back", "Core", "Quadriceps", "Hamstrings") var muscle_groups
